...
#### From Jenkins home page select "New Item"
   ...
   - *Source Code Management:*
      - Repository: `https://github.com/ebiecas02/XYZ-Technologies`
      - Branches to build : ``  
   - *Poll SCM* :      - `* * * *`
     ...
     - *SSH Publishers*
      - SSH Server Name: `docker-host`
       - `Transfers` >  `Transfer set`
            - Source files: `XYZtechnologies/target/*.war`
	       - Remove prefix: `XYZtechnologies/target`
	       - Remote directory: `//home//ansadmin` or `.`
	       - Exec command: 
                ```sh 
                cd /home/dockeradmin;
                docker build -t project2-devops-image .; 
                docker run -d --name project2-devops-container -p 8080:8080 project2-devops-image;
                ```
